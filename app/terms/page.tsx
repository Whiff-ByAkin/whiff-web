...
export default function TermsPage() {
  return (
    <LegalShell title="Terms of Service" updated="August 20, 2026">
      <p>
        These Terms of Service (&ldquo;<strong>Terms</strong>&rdquo;) are a
        binding agreement between you and{" "}
        <strong>Whiff LLC</strong>, a Delaware limited liability company
        (&ldquo;whiff,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo;
        &ldquo;our&rdquo;). They govern your use of the whiff website, the whiff
        mobile application, and every activity, circle, and service we provide
        (together, the &ldquo;<strong>Service</strong>&rdquo;).
      </p>
      <p>
        They also serve as the <strong>end user license agreement</strong> for
        the whiff app. By creating an account, starting a free trial, buying a
      ...
      <p>
        <strong>
          ...
          resolution) carefully. Section 9 describes real risks of meeting
          people in person. Section 16 requires most disputes to be resolved by
      ...
      <h2>1. What whiff is, and what it is not</h2>
      <p>
        whiff places you in a <strong>circle</strong> of four adults in your
        city and plans a run of real-world activities for those same four people
        over roughly twelve weeks. We use what you tell us during onboarding,
        and what happens at the activities afterward, to decide who belongs in a
        circle together.
      </p>
      <p>whiff is expressly not:</p>
      <ul>
        <li>
          a <strong>dating, romance, matchmaking, escort, or introduction
          service</strong> for romantic or sexual purposes;
        </li>
        <li>
          a <strong>background-check or identity-verification provider</strong>.
          We do not run criminal background checks, sex-offender registry
          checks, or identity verification on members, and you should not assume
          anyone has been vetted;
        </li>
        <li>
          an <strong>employer, event organizer, tour operator, guide, or
          venue</strong>. We do not staff, supervise, lead, insure, or control
          any activity;
        </li>
        <li>
          a provider of <strong>medical, legal, financial, or mental-health
          advice</strong>.
        </li>
      </ul>

      <h2>2. Who may use whiff</h2>
      <p>
        ...
        You may not use whiff if we have previously removed you.
      </p>
      <p>
        whiff operates city by city. A seat depends on there being enough people
        in your city to form a circle, and we do not promise one by any
        particular date.
      </p>
      ...
      <p>
        ...
        responsible for your password and for everything that happens under your
        account. Tell us at{" "}
        <a href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</a> straight away if
      ...
      <p>
        ...
        <strong>auto-renewing subscription</strong>. When you subscribe through
        the whiff iOS app, the following applies:
      </p>
      <ul>
        <li>
          <strong>What you get.</strong> A whiff subscription is access to the
          whole service: placement into a circle, the activities planned for it,
          and everything whiff learns and does on your behalf while it is
        ...
        <li>
          ...
          <strong>renews automatically</strong> at the then-current price unless
          you cancel it at least <strong>24 hours before the end of the current
          period</strong>. Payment is charged to your Apple Account at
          confirmation of purchase, and your account is charged for renewal
        ...
        <li>
          ...
          subscription, your access continues to the end of the period you have
          already paid for. We do this deliberately: cutting somebody off in the
          middle of a circle takes three other people&rsquo;s evening with it.
        </li>
      </ul>
      <p>
        <strong>Refunds are handled by Apple, not by us.</strong> Purchases made
        through the App Store are subject to Apple&rsquo;s terms and refund
      ...
      <p>
        ...
        effect is your acceptance of it; if you do not accept it, cancel before
        the next renewal.
      </p>

      <h2>5. What whiff learns about you, and how</h2>
      <p>
      ...
      <p>
        ...
        <a href="/privacy">Privacy Policy</a> explains this in detail, including
        your rights over automated processing.
      </p>
      <p>
        whiff&rsquo;s inferences are guesses, not facts about you, and it will
        be wrong sometimes. Do not treat them as an assessment of your
        character, health, or suitability for anything outside whiff.
      </p>

      <h2>6. Your content</h2>
      <p>
        You keep ownership of what you write in whiff — your onboarding answers,
        feedback, corrections, and messages. You grant us a worldwide,
        non-exclusive, royalty-free licence to host, store, reproduce, and
        process that content <strong>solely to operate and improve the
        Service</strong>, including running it through the automated systems
        described in section 5.
      </p>
      <p>
        Do not submit content you do not have the right to submit, and do not
        submit other people&rsquo;s personal information.
      </p>
      ...
      <ul>
        ...
        <li>
          share another member&rsquo;s name, photo, contact details, location,
          or anything else they told you in confidence, outside the circle;
        </li>
        <li>
        ...
        <li>
          break the law, or a venue&rsquo;s rules, at an activity;
        </li>
        <li>
      ...
      <h2>8. Reporting, blocking, and enforcement</h2>
      <p>
        ...
        permanent unless you lift it, and whiff will never place you in a circle
        with somebody you have blocked.
      </p>
      <p>
      ...
      <h2>9. Real-world activities and assumption of risk</h2>
      <p>
        <strong>
      ...
      <p>
        You participate <strong>voluntarily and entirely at your own
        risk</strong>. You are responsible for your own safety and your own
        decisions, including judging each activity for yourself, meeting in
        public where that is sensible, telling somebody you trust where you are
        going, arranging your own transport, and following the law and the
        venue&rsquo;s rules. Some activities — hiking, climbing, cycling,
        skating, water sports, and similar — carry inherent risks of serious
        injury or death. You knowingly assume those risks.
      </p>
      <p>
        To the fullest extent permitted by law, you release whiff from claims
        arising out of the conduct of other members, the condition of any venue,
        or anything that happens at or on the way to or from an activity.
      </p>

      <h2>10. Third-party venues, activities, and services</h2>
      <p>
      ...
      <p>
        ...
        non-transferable, non-sublicensable, revocable licence to use the whiff
        app on Apple-branded devices that you own or control, as permitted by
        the App Store Usage Rules, for your own non-commercial use. That is the
        whole of what is granted; everything else is reserved.
      </p>

      <h2>12. Availability and changes to the Service</h2>
      <p>
        whiff is a young product and it changes. We may add, alter, suspend, or
        discontinue any part of the Service, including cities, activity types,
        and features. We try to give notice of material changes, but we may act
        immediately where we need to for security, legal, or safety reasons. We
        do not promise the Service will be uninterrupted or error-free.
      </p>

      <h2>13. Termination</h2>
      <p>
        <strong>You may stop at any time.</strong> Cancel your subscription in
        your Apple Account settings, and delete your account from inside the app
        (<strong>You &rarr; Account &rarr; Delete account</strong>) or by
        emailing <a href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</a>.
        Deleting your account does not by itself cancel your Apple subscription
        — you must do both.
      </p>
      <p>
        ...
        to protect another member. Sections 6, 9, 11, 14, 15, 16, and 17 survive
        termination.
      </p>
      ...
      <p>
        To the fullest extent permitted by law, whiff and its members, managers,
        employees, and agents <strong>will not be liable for any indirect,
        incidental, special, consequential, exemplary, or punitive damages</strong>,
        or for lost profits, lost data, or loss of goodwill, arising out of or
        relating to the Service or these Terms, whether in contract, tort, or
        any other theory, even if we were advised such damages were possible.
      </p>
      <p>
        <strong>
          Our total liability for all claims relating to the Service is limited
          to the greater of (a) the amount you paid us in the twelve months
      ...
      <p>
        ...
        do not allow limits on incidental or consequential damages, so parts of
        this section may not apply to you.
      </p>

      <h2>16. Dispute resolution, arbitration, and class action waiver</h2>
      <p>
      ...
      <p>
        ...
        description of the dispute and what you want. We will try to resolve it
        with you for 60 days. Most things end here.
      </p>
      <p>
        ...
        rather than in court. The Federal Arbitration Act governs this section.
        Arbitration may take place in the county where you live or by video or
        telephone, at your choice. An arbitrator can award the same individual
        relief a court could.
      </p>
      <p>
      ...
      <p>
        ...
        <strong>not as a plaintiff or class member in any class,
        consolidated, or representative proceeding</strong>. An arbitrator may
        not consolidate more than one person&rsquo;s claims. If this waiver is
        found unenforceable as to a particular claim, that claim — and only that
        claim — proceeds in court.
      </p>
      <p>
      ...
      <p>
        ...
        relief in court to stop infringement or misuse of intellectual property.
      </p>
      <p>
        <strong>
          How to opt out.
        </strong>{" "}
        You can opt out of this arbitration and class action waiver by emailing{" "}
        <a href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</a> with the subject
        line <strong>&ldquo;Arbitration Opt-Out&rdquo;</strong> and your name
        and account email, <strong>within 30 days</strong> of first accepting
      ...
      <p>
        ...
        laws rules. Where a dispute is not subject to arbitration, you and whiff
        agree to the exclusive jurisdiction of the state and federal courts
        located in Delaware. If you are a consumer resident elsewhere, this does
        not deprive you of the protection of mandatory consumer laws in your
        place of residence.
      </p>

      <h2>18. The App Store</h2>
      <p>
        These terms apply to the whiff app obtained from Apple&rsquo;s App
        Store, and are required by Apple:
      </p>
      <ul>
        <li>
          This agreement is between <strong>you and Whiff LLC only, and not with
          Apple</strong>. Apple is not responsible for the app or its content.
        </li>
        <li>
        ...
        <li>
          <strong>Apple has no obligation to provide maintenance or support</strong>{" "}
          for the app. Support is ours — email{" "}
          <a href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</a>.
        </li>
        <li>
          To the extent permitted by law, Apple has{" "}
          <strong>no warranty obligation</strong> for the app. If the app fails
          to conform to any applicable warranty, you may notify Apple and Apple
          will refund the purchase price of the app, if any. Apple has no other
          warranty obligation whatsoever.
        </li>
        <li>
        ...
        <li>
          <strong>Whiff LLC, not Apple, is responsible</strong> for investigating
          and defending any third-party claim that the app infringes that
          party&rsquo;s intellectual property rights.
        </li>
        <li>
          You represent that you are <strong>not located in a country subject to
          a U.S. Government embargo</strong> or designated as a &ldquo;terrorist
          supporting&rdquo; country, and that you are not on any U.S. Government
        ...
        <li>
          <strong>
            Apple and Apple&rsquo;s subsidiaries are third-party beneficiaries
            of these Terms
          </strong>{" "}
          and, upon your acceptance, will have the right to enforce them against
          you.
        </li>
        <li>
      ...
      <p>
        ...
        <a href="/privacy">Privacy Policy</a>, are the entire agreement between
