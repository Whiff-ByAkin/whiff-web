      ...
      <>
        ...
        <ul>
          ...
          <li>
            ...
            </strong>: application hosting and database infrastructure.
          </li>
          <li>
            <strong>
              <a href="https://resend.com/legal/privacy-policy">Resend</a>
            </strong>: sending transactional email.
          </li>
          <li>
            <strong>
              <a href="https://www.apple.com/legal/privacy/">Apple</a>
            </strong>: subscription billing and App Store distribution.
          </li>
          <li>
            <strong>
              <a href="https://vercel.com/legal/privacy-policy">Vercel</a>
            </strong>: website hosting and privacy-friendly, cookieless analytics.
          </li>
          <li>
            <strong>
          ...
          <li>
            ...
            </strong>: crash and performance diagnostics (section 2).
          </li>
        </ul>
        <p>
    ...
    body: (
      <>
        <p>
          ...
          after that only as long as we need it for the purposes in this
          policy, typically to resolve disputes, meet legal and tax
          obligations, and
