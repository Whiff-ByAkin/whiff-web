...
export const POSTS: Post[] = [
  {
    ...
    paragraphs: [
      ...
      "The first circles are forming in Minneapolis–Saint Paul. App Store and Google Play links are coming soon. An immediate match or an activity in your first week is not guaranteed. Suggestions depend on local availability as circles come together.",
