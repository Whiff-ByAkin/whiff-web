...
export const POSTS: Post[] = [
  {
    ...
    paragraphs: [
      ...
      "The first circles are forming in Minneapolis–Saint Paul. Right now, the website takes invite-list signups for updates and next steps. Joining that list does not begin a subscription or guarantee a match or an activity in your first week. Suggestions depend on local availability as circles come together.",
