/** Shared product facts used by visible pages, structured data and /llms.txt.
 * Keep launch status and availability accurate across every surface. */
...
export const DEFINITIONS: { term: string; definition: string }[] = [
  ...
  },
  {
    ...
    definition:
      "Activity suggestions while a circle forms depend on local availability. Immediate outings or invitations from existing circles are not guaranteed.",
  },
  {
    term: "The bet",
    definition:
...
export const STEPS = [
  ...
  {
    name: "Let your circle come together",
    text: "Whiff uses interests and availability to form compatible local circles. Timing depends on who is joining near you; immediate matching is not guaranteed.",
  },
  {
...
export const FAQ: { question: string; answer: string }[] = [
  ...
  },
  {
    ...
    answer:
      "You answer a short set of questions about what you enjoy doing and when you are free. In the background whiff forms a circle of four compatible people near you, then plans a series of real-world activities for that same four so a friendship has room to develop.",
  },
  {
